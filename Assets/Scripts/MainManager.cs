...
public class MainManager : MonoBehaviour
{
  ...
  public void Start()
  {
    ...
    CurrentName = DataController.GetCurrentUserName();
    const float step = 0.6f;
    int perLine = Mathf.FloorToInt( 4.0f / step );
    TopScoreEntry = DataController.GetTopScoreEntry();
    TopScoreText.text = "Best Score: " + TopScoreEntry.UserName + " : " + TopScoreEntry.HighScore;
  ...
  public void AddPoint(int point)
  {
    ...
    if ( m_Points > TopScoreEntry.HighScore )
    {
